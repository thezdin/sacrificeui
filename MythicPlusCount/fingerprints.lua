-- MythicPlusCount - Pre-built fingerprint data
-- Collected for Midnight Season 1 (all 8 dungeons)
-- Format: [challengeMapID] = { ["fingerprint"] = npcID, ... }
-- Users can override with /mpc teach
local ADDON_NAME, NS = ...
local MPC = NS.MPC

MPC.DefaultFingerprints = {
