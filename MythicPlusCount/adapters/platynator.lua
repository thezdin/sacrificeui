-- MythicPlusCount - Platynator Adapter
...
MPC.Adapters.Platynator = Platynator

local overlays = {}

function Platynator:IsAvailable() return _G.Platynator ~= nil end
function Platynator:Init() MPC:Debug("Platynator adapter initialized") end

function Platynator:OnNameplateAdded(unitToken)
...
function Platynator:OnNameplateRemoved(unitToken)
    local nameplate = C_NamePlate.GetNamePlateForUnit(unitToken)
    if nameplate then self:HideOverlay(nameplate) end
end

function Platynator:GetOrCreateOverlay(nameplate)
...
function Platynator:ShowOverlay(nameplate, info)
...
function Platynator:HideOverlay(nameplate)
